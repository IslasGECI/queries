...
@test "select_growth_rates_and_p_values_seabirds" {
  ...
  result="$(./src/select_growth_rates_and_p_values tests/data/seabirds_growth_rates.csv p_value "<= 0.1" 2)"
  [ "$output" = "$result" ]
}
...
@test "select_growth_rates_and_p_values_regional_seabirds" {
  ...
  result="$(./src/select_growth_rates_and_p_values tests/data/seabirds_all_islets_growth_rates.csv p_value "<= 0.1" 3)"
  [ "$output" = "$result" ]
}
